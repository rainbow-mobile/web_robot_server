        ...
        try {
            fs.open(dir, "r", (err, fd) => {
                if (err) {
                    ...
                    reject({ status: common_1.HttpStatus.NOT_FOUND, data: { message: http_status_messages_constants_1.HttpStatusMessagesConstants.FILE.NOT_FOUND_404 } });
                }
                else {
            ...
            reject({ status: common_1.HttpStatus.INTERNAL_SERVER_ERROR, data: { message: http_status_messages_constants_1.HttpStatusMessagesConstants.FILE.FAIL_READ_500 } });
        }
    });
}
async function deleteFile(dir) {
    return new Promise(async (resolve, reject) => {
        try {
            fs.open(dir, "r", (err, fd) => {
                if (err) {
                    ...
                    fs.unlink(dir, (err) => {
                        if (err) {
                            http_logger_1.default.error(`[FILE] deleteFile: ${dir}, ${(0, error_util_1.errorToJson)(err)}`);
                            reject({ status: common_1.HttpStatus.INTERNAL_SERVER_ERROR, data: { message: http_status_messages_constants_1.HttpStatusMessagesConstants.FILE.FAIL_DELETE_500 } });
                        }
                        resolve({ message: http_status_messages_constants_1.HttpStatusMessagesConstants.FILE.SUCCESS_DELETE_200 });
                    });
                }
            });
        }
            ...
            reject({ status: common_1.HttpStatus.INTERNAL_SERVER_ERROR, data: { message: error } });
        }
    });
}
async function saveJson(dir, data) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            resolve({ message: http_status_messages_constants_1.HttpStatusMessagesConstants.FILE.SUCCESS_WRITE_201, data: data });
        }
        catch (error) {
...
async function saveCsv(dir, data) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            reject({ status: common_1.HttpStatus.INTERNAL_SERVER_ERROR, data: { message: http_status_messages_constants_1.HttpStatusMessagesConstants.FILE.FAIL_WRITE_500 } });
        }
    });
}
