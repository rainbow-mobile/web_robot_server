...
const mdns_module_1 = require("./mdns/mdns.module");
const config_2 = require("./modules/config");
const update_module_1 = require("./modules/apis/update/update.module");
const test_module_1 = require("./modules/apis/test/test.module");
