...
import { SettingRequestSlamnav, SettingResponseDto } from './dto/setting.dto';
export declare class SettingService {
    private readonly socketGateway;
    constructor(socketGateway: SocketGateway);
    getSetting(type: string): Promise<any>;
    settingRequest(dto: SettingRequestSlamnav): Promise<SettingResponseDto>;
    ...
    cameraOrderChange(data: CameraOrderChangeDto): Promise<unknown>;
}
