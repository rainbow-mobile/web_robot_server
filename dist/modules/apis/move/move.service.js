        ...
        return new Promise(async (resolve, reject) => {
            if (this.socketGateway.slamnav != null) {
                ...
                this.socketGateway.slamnav.once('moveResponse', (data2) => {
                    ...
                    http_logger_1.default.info(`[MOVE] moveCommand Response: ${responseJson.result}, ${JSON.stringify(data2)} `);
                    if (responseJson.result === 'accept' ||
                        responseJson.result === 'accept') {
                        resolve(responseJson);
                    }
                    else {
                        reject({ data: responseJson, status: common_1.HttpStatus.FORBIDDEN });
                    }
