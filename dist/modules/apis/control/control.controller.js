...
let ControlController = class ControlController {
    ...
    async resetSafetyFlag(dto) {
        try {
            ...
            if (error instanceof common_1.HttpException)
                throw error;
            http_logger_1.default.error(`[COMMAND] resetSafetyField : ${(0, error_util_1.errorToJson)(error)}`);
            throw new common_1.HttpException('요청을 처리할 수 없습니다', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async setSafetyField(dto) {
        try {
            ...
            if (error instanceof common_1.HttpException)
                throw error;
            http_logger_1.default.error(`[COMMAND] getSafetyField : ${(0, error_util_1.errorToJson)(error)}`);
            throw new common_1.HttpException('요청을 처리할 수 없습니다', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [safety_dto_1.ResetSafetyFlagDto]),
    __metadata("design:returntype", Promise)
], ControlController.prototype, "resetSafetyFlag", null);
__decorate([
    (0, common_1.Post)('safety/field'),
    (0, swagger_1.ApiOperation)({
    ...
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [safety_dto_1.SetSafetyFieldDto]),
    __metadata("design:returntype", Promise)
], ControlController.prototype, "setSafetyField", null);
__decorate([
    (0, common_1.Get)('safety/field'),
    (0, swagger_1.ApiOperation)({
    ...
    __metadata("design:returntype", Promise)
], ControlController.prototype, "getSafetyField", null);
__decorate([
    (0, common_1.Get)('dock'),
    (0, swagger_1.ApiOperation)({
        summary: '도킹 시작',
