...
const movestate_entity_1 = require("./status/movestate.entity");
...
__decorate([
    ...
    (0, typeorm_1.Column)({ name: 'map', type: 'varchar', length: 32 }),
    __metadata("design:type", String)
], StatusLogEntity.prototype, "map", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        example: {},
    }),
...
__decorate([
    ...
    __metadata("design:type", movestate_entity_1.MoveStatusStateEntity)
