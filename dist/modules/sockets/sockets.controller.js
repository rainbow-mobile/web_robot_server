...
const sequence_dto_1 = require("./dto/sequence.dto");
let SocketsController = class SocketsController {
    ...
    onModuleInit() {
        ...
        this.getVariable().then(() => {
            (0, equipment_logger_1.generateGeneralLog)({
                ...
                status: equipment_enum_1.GeneralStatus.IDLE,
                scope: equipment_enum_1.GeneralScope.EVENT,
                operationName: equipment_enum_1.GeneralOperationName.PROGRAM_START,
    ...
    async sequenceManipulator(scope, data) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SocketsController.prototype, "setAlarm", null);
__decorate([
    (0, common_1.Post)('sequence/:scope'),
    (0, swagger_1.ApiOperation)({
        summary: '시퀀스 LOG 저장',
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, sequence_dto_1.SequenceDto]),
    __metadata("design:returntype", Promise)
], SocketsController.prototype, "sequenceManipulator", null);
