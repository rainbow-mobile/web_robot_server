...
let SocketGateway = class SocketGateway {
        ...
        try {
            ...
            this.frsSocket.on('path', (_data) => {
                try {
                    ...
                    const data = _data;
                    const json = JSON.parse(data);
                    if ((0, lodash_1.isEqual)(json, this.lastFRSPath)) {
            ...
            this.frsSocket.on('vobsRobots', (_data) => {
                try {
                    ...
                    const data = _data;
                    const json = JSON.parse(data);
                    if ((0, lodash_1.isEqual)(json, this.lastFRSVobsRobot)) {
            ...
            this.frsSocket.on('vobsClosures', (_data) => {
                try {
                    ...
                    const data = _data;
                    const json = JSON.parse(data);
                    if ((0, lodash_1.isEqual)(json, this.lastFRSVobsClosure)) {
    ...
    async handleStatusMessage(payload, client) {
        try {
            if (client.id == this.slamnav?.id) {
                ...
                if ((0, lodash_1.isEqual)(json, this.lastStatus)) {
                    return;
                }
    ...
    async handleWorkingStatusMessage(payload, client) {
        try {
            if (client.id == this.slamnav?.id) {
                ...
                const json = JSON.parse(payload);
                if ((0, lodash_1.isEqual)(json, this.lastMoveStatus)) {
                    return;
                }
    ...
    async handleLidarCloudMessage(payload) {
        try {
            ...
            if ((0, lodash_1.isEqual)(payload, this.lastLidarCloud)) {
                return;
            }
    ...
    async handleMappingCloudMessage(payload) {
        try {
            ...
            if ((0, lodash_1.isEqual)(payload, this.lastMappingCloud)) {
    ...
    async handleLocalPathdMessage(payload) {
        try {
            ...
            if ((0, lodash_1.isEqual)(payload, this.lastLocalPath)) {
    ...
    async handleGlobalPathdMessage(payload) {
        try {
            ...
            if ((0, lodash_1.isEqual)(payload, this.lastGlobalPath)) {
                return;
            }
