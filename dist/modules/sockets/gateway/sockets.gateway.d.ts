...
export declare class SocketGateway implements OnGatewayConnection, OnGatewayDisconnect, OnModuleDestroy, OnGatewayInit {
    ...
    constructor(networkService: NetworkService, moveRepository: Repository<MoveLogEntity>);
    afterInit(): void;
    server: Server;
    socket: Socket;
    tcpServer: any;
    ...
    handlePathResponse(payload: string): Promise<void>;
    ...
    handleCameraInfoMessage(payload: string): Promise<void>;
    handleCameraInfoResponseMessage(payload: string): Promise<void>;
    handleCameraOrderChangeMessage(payload: string): Promise<void>;
    handleCameraOrderChangeResponseMessage(payload: string): Promise<void>;
