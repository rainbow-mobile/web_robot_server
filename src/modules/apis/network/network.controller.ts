...
export class NetworkController {
  ...
  async getCurrentNetwork(@Res() res: Response) {
    try {
      ...
      httpLogger.debug(
        `[NETWORK] getCurrentNetwork: ${JSON.stringify(response)}`,
      );
      res.send(response);
    } catch (error) {
      httpLogger.error(
        `[NETWORK] getCurrentNetwork: ${error.status} -> ${error.data}`,
      );
  ...
  async getCurrentNetworkWifi(@Res() res: Response) {
    try {
      ...
      httpLogger.debug(
        `[NETWORK] getCurrentNetworkWifi: ${JSON.stringify(response)}`,
      );
      res.send(response);
    } catch (error) {
      httpLogger.error(
        `[NETWORK] getCurrentNetworkWifi: ${error.status} -> ${error.data}`,
      );
      return res.status(error.status).send(error.data);
    }
  }
  ...
  async getWifiList(@Res() res: Response) {
    try {
      ...
      httpLogger.error(
        `[NETWORK] getWifiList: ${error.status} -> ${error.data}`,
      );
      return res.status(error.status).send(error.data);
    }
  }
  ...
  async scanWifiList(@Res() res: Response) {
    try {
      ...
      httpLogger.error(
        `[NETWORK] scanWifiList: ${error.status} -> ${error.data}`,
      );
      return res.status(error.status).send(error.data);
    }
  }
  ...
  async updateNetwork(@Body() data: NetworkDto, @Res() res: Response) {
    try {
      ...
      httpLogger.error(
        `[NETWORK] updateNetwork: ${error.status} -> ${error.data}`,
      );
      return res.status(error.status).send(error.data);
    }
  }
  ...
  async connectWifi(@Body() data: NetworkWifiDto, @Res() res: Response) {
    try {
      ...
      httpLogger.error(
        `[NETWORK] connectWifi: ${error.status} -> ${error.data}`,
      );
      return res.status(error.status).send(error.data);
    }
  }
